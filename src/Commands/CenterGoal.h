...
#ifndef CENTER_GOAL_H
#define CENTER_GOAL_H
...
public:
	...
	CenterGoal(float width, float centerX, /*float centerY,*/ float widthTolerance=3, float centerXTolerance=3/*, float centerYTolerance=0.1*/);
